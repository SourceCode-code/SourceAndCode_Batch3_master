...
let days_28or29 = `february`
if(days_31.includes(MONTH)){
    console.log(`It's ${MONTH}, and it has 31 days`)
}
else if(days_30.includes(MONTH)){
    console.log(`It's ${MONTH}, and it has 30 days`)
}
else{
    console.log(`It's ${MONTH}, and it has 28 or 29 days. So the cycle after every 4 years it become a leap year`)
}
