...
// console.log(sent.substr(sent1,sent2-1))

// // using substring
// let sent3 = sent.indexOf('because')
// let sent4 = sent.lastIndexOf('because')+'because'.length
// console.log(sent.substring(sent3,sent4))